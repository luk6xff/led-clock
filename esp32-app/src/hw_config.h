...
// LIGHT ILLUMINANCE SENSOR - MAX44009
#define MAX44009_I2C_ADDR   0x4A //0b1001101x -- A0 PIN is conected to VDD
#define MAX44009_SDA_PIN    GPIO_NUM_21
#define MAX44009_SCL_PIN    GPIO_NUM_22
