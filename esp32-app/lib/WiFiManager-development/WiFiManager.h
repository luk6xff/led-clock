...
class WiFiManager
{
  public:
    ...
    void          setSaveConfigCallback( std::function<void(String, String)> func );
  ...
  private:
    ...
    String        _wifissidprefix         = _apName;//FPSTR(S_ssidpre); // auto apname prefix prefix+chipid
    ...
    std::function<void(String, String)> _savewificallback;
